...
|--------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|-------------------------------------------------------------------------------------------------|
| [Positional Hold Tap](https://zmk.dev/docs/keymaps/behaviors/hold-tap#positional-hold-tap-and-hold-trigger-key-positions)                        | [Chordal Hold](https://github.com/qmk/qmk_firmware/blob/master/docs/tap_hold.md#chordal-hold) | tap-hold-release-keys                        | Hold behaviour only on cross-hand key combinations                                              |
| [supporting feature Hold-trigger-on-release](https://zmk.dev/docs/keymaps/behaviors/hold-tap#positional-hold-tap-and-hold-trigger-key-positions) | [Retro Tapping](https://docs.qmk.fm/tap_hold#retro-tapping)                                   |                                              | Allow multiple modifiers to be held on home row, delaying decision to tap on next same-side key |
...
| Quick Tap Ms                                                                                                                                     | Quick Tap Term                                                                                                                               |                       | Tap, then long-press a tap-hold key within timeframe activates tap                              |
